        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.35fr 1fr', gap: 48, alignItems: 'end' }}>
          <div>
            ...
            <div style={{ display: 'flex', gap: 12, marginTop: 24 }}>
              <a href="https://apps.apple.com/us/app/go-virall-social-intelligence/id6761445990" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '10px 20px', background: '#000', borderRadius: 12, textDecoration: 'none', color: '#fff', lineHeight: 1.2, border: '1px solid #333' }}>
                ...
                <span><span style={{ fontSize: 9, opacity: 0.8, display: 'block', fontFamily: 'system-ui, sans-serif' }}>Download on the</span><span style={{ fontSize: 16, fontWeight: 600, fontFamily: 'system-ui, sans-serif' }}>App Store</span></span>
              </a>
              <a href="https://play.google.com/store/apps/details?id=com.govirall.app" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '10px 20px', background: '#000', borderRadius: 12, textDecoration: 'none', color: '#fff', lineHeight: 1.2, border: '1px solid #333' }}>
                <svg width="20" height="22" viewBox="0 0 24 24" fill="none"><path d="M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 0 1-.61-.92V2.734a1 1 0 0 1 .609-.92z" fill="#4285F4"/><path d="M17.545 8.297L14.58 10.01l-.788.788L3.61 1.814l.107-.052 13.828 7.535z" fill="#EA4335"/><path d="m20.061 10.658-2.516-1.361-3.753 3.753 2.516 2.252 3.753-2.044c.583-.319.583-1.6 0-2.6z" fill="#FBBC04"/><path d="M3.717 22.238l10.076-10.032 3.752 2.044-13.72 7.936-.108.052z" fill="#34A853"/></svg>
                <span><span style={{ fontSize: 9, opacity: 0.8, display: 'block', fontFamily: 'system-ui, sans-serif' }}>GET IT ON</span><span style={{ fontSize: 16, fontWeight: 600, fontFamily: 'system-ui, sans-serif' }}>Google Play</span></span>
              </a>
            </div>
          </div>
          <aside>
