        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.35fr 1fr', gap: 48, alignItems: 'end' }}>
          <div>
            ...
            <div style={{ display: 'flex', gap: 12, marginTop: 16, flexWrap: 'wrap', alignItems: 'center' }}>
              <a
                href="https://apps.apple.com/us/app/go-virall-social-intelligence/id6761445990"
                target="_blank"
              ...
              >
                ...
                <span>
                  <span style={{ fontSize: 9, opacity: 0.85, display: 'block' }}>Download on the</span>
                  <span style={{ fontSize: 15, fontWeight: 600 }}>App Store</span>
                </span>
              </a>
              <a
                href="https://play.google.com/store/apps/details?id=com.govirall.app"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  display: 'inline-flex',
              ...
              >
                ...
                <span>
                  <span style={{ fontSize: 9, opacity: 0.85, display: 'block' }}>GET IT ON</span>
